...
public class TestClassForMath9 extends TestCase {
...
public void testSummaXxxx9() throws InterruptedException {
...
public void testDifferenceXxx9() throws InterruptedException {
    ClassForMath tester = new ClassForMath();
...
public void testDifferenceXxx9a() throws InterruptedException {
//sdfsfdfsdfdfsdf
    ClassForMath tester = new ClassForMath();
	 Thread.sleep(10000);
       Assert.assertEquals("Result", 7, tester.difference(12, 5));
...
public void testDifference7Xxx9a() throws InterruptedException {
    ClassForMath tester = new ClassForMath();
	 Thread.sleep(10000);
       Assert.assertEquals("Result", 7, tester.difference(12, 5));

}
public void testDivisionXxx9() throws InterruptedException {
    ClassForMath tester = new ClassForMath();
	 Thread.sleep(10000);
       Assert.assertEquals("Result", 8, tester.division(8,1));}

public void testDoubleSummaXxx9() throws InterruptedException {
	//dfdfdfsfsdfsfdsfsf
	//dfsfdfsdfdfsdfsff
    ClassForMath tester = new ClassForMath();
	 Thread.sleep(10000);
...
public void testTripleSummaXxx9() throws InterruptedException
